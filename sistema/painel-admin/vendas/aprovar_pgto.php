...
$id_venda = $_POST['id'];
$id_forma_pagamento = $_POST['formapgto'];
...
if($pago != 'Sim'){
    ...
    $pdo->query("UPDATE vendas SET pago = 'Sim', id_forma_pagamento = '$id_forma_pagamento' where id = '$id_venda' ");
    
    //LANÇAR EM MOVIMENTAÇÕES
    $descricao = "Pedido $id_venda - Online";
    
    $pdo->query("INSERT INTO movimentacoes SET tipo = 'Entrada', data = curDate(), usuario = '$id_funcionario', descricao = '$descricao', valor = '$valor_pgto', id_mov = '$id_venda', forma_pgto = '$id_forma_pagamento'");
