...
$idFornecedor = $_GET['pedidoFornecedor'];
$pedidoStatus = $_GET['pedidoStatus'];

$query = $pdo->query("SELECT * from fornecedores where id = $idFornecedor");
$res = $query->fetchAll(PDO::FETCH_ASSOC);
$dadosFornecedor = $res[0]['nome'] . " - " . $res[0]['telefone'];
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-sm-8 esquerda">	
				<span class="titulorel"> Relatório de Encomendas </span>
			</div>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="esquerda_float margem-direita50">	
					<span class=""> <b> Fornecedor: </b> </span>
				</div>
				<div class="esquerda_float margem-direita50">	
					<span class=""> <?php echo $dadosFornecedor  ?> </span>
				</div>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="esquerda_float margem-direita50">	
					<span class=""> <?php echo $pedidoStatus   ?> </span>
				</div>
		...
		<table class='table' width='100%'  cellspacing='0' cellpadding='3'>
			...
			WHERE
				v.status = '$pedidoStatus' and p.id_fornecedor = '{$idFornecedor}'
