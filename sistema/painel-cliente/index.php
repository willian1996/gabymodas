...
$cpf_usu = @$dados[0]['cpf'];
$res = $pdo->query("SELECT * FROM clientes where cpf = '$cpf_usu'"); 
$dados = $res->fetchAll(PDO::FETCH_ASSOC);
...
$rua_usu = @$dados[0]['rua'];
$numero_usu = @$dados[0]['numero'];
$bairro_usu = @dados[0]['bairro'];
$cidade_usu = @dados[0]['cidade'];
$estado_usu = @dados[0]['estado'];
$cep_usu = @dados[0]['cep'];
$complemento_usu = @dados[0]['complemento'];
...
<body id="page-top">
    ...
    <div id="wrapper">
     ...
     <input value="<?php echo @$telefone_usu ?>" type="text" class="form-control" id="telefone-usuario" name="telefone-usuario" placeholder="">
    
  </div>

    <div class="form-group">
     <label for="exampleInputEmail1">CEP</label>
     <input value="<?php echo @$cep_usu ?>" type="text" class="form-control" id="cep-usuario" name="cep-usuario" >
    
  </div>
  <div class="form-group">
     <label  for="exampleInputEmail1">Endereço</label>
     <input value="<?php echo @$rua_usu ?>" type="text" class="form-control" id="rua-usuario" name="rua-usuario">
    
  </div>
 <div class="form-group">
     <label for="exampleInputEmail1">Número</label>
     <input value="<?php echo @$numero_usu ?>" type="text" class="form-control" id="numero-usuario" name="numero-usuario">
    
  </div>
 <div class="form-group">
     <label for="exampleInputEmail1">Bairro</label>
     <input value="<?php echo @$bairro_usu ?>" type="text" class="form-control" id="bairro-usuario" name="bairro-usuario">
    
  </div>
   <div class="form-group">
     <label for="exampleInputEmail1">Cidade</label>
     <input value="<?php echo @$cidade_usu ?>" type="text" class="form-control" id="cidade-usuario" name="cidade-usuario">
    
  </div>
 <div class="form-group">
     <label for="exampleInputEmail1">Estado</label>
     <input value="<?php echo @$estado_usu ?>" type="text" class="form-control" id="estado-usuario" name="estado-usuario">
    
  </div>
  <div class="form-group">
     <label for="exampleInputEmail1">Ponto de referência</label>
     <input value="<?php echo @$complemento_usu ?>" type="text" class="form-control" id="complemento-usuario" name="complemento-usuario">
...
<script>
  function verProdutos(idvenda) {
    ...
    $.ajax({
      url: "pedidos/listar-produtos.php",
      method: "post",
      data: {idvenda},
      dataType: "html",
