...
<div class="col-lg-9 col-md-7">
        ...
        $query = $pdo->query("SELECT * FROM produtos where (nome LIKE '$buscar' or palavras like '$buscar') and ativo = 'Sim' and estoque > 0 order by data desc LIMIT $limite, $itens_por_pagina ");
