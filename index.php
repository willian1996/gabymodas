            ...
            <form id="form-dados"  class="col s12" action="server/cadastro-backend.php" method="post">
                ...
                <div class="row">
                    <div class="input-field col s12">
                        ...
                        <input id="telefone" placeholder="whatsapp* (o mesmo do pedido)" name="whatsapp" type="tel" required>
                    </div>
                </div>
                <!--Rua-->
                <div class="row">
                ...
                <div class="row">
                    <div class="input-field col s12">
                        ...
                        <input id="telefone" placeholder="Telefone 1 (opcional)" name="telefone1" type="tel">
                    </div>
                </div>
                <!--Telefone 2-->
                <div class="row">
                    <div class="input-field col s12">
                        <i class="small material-icons">phone</i>
                        <input id="telefone" placeholder="Telefone 2 (opcional)" name="telefone2" type="tel">
                    </div>
                </div>
                <!-- observação -->
                <div class="row">
                    <div class="input-field col s12">
                        <textarea placeholder="Ponto de Referência e Observação" id="message2" name="observacao" class="materialize-textarea"></textarea>
                    </div>
                </div>
                <!----Botão enviar---->
                <div class="row">
